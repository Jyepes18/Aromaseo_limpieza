...
$resgistro = "SELECT * FROM pedido WHERE Cod_pedido = '$id' ";
?>
...
<body>
    ...
    <div class="table__title table__title--edit">Actualizar</div>
        ...
        while ($row = mysqli_fetch_assoc($resultado)) {
            ...
            <input type="hidden"  class="table__item " value="<?php echo $row["Cod_pedido"];?>" name="id">
            ...
            <input type="text"  class="table__input" value="<?php echo $row["Cod_Domicilio"]; ?>" name="Cod_Domicilio">
