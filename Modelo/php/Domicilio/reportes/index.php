...
function Header()
{
    ...
    $this->Cell(35,10, 'Docuemnto ', 1, 0, 'c', 0);
...
while($row = $resultado->fetch_assoc()){
    $pdf->Cell(35,10, $row['Nombre_Cliente'], 1, 0, 'c', 0);
    $pdf->Cell(35,10, $row['Doc_Cliente'], 1, 0, 'c', 0);
    $pdf->Cell(30,10, $row['Producto'], 1, 0, 'c', 0);
    $pdf->Cell(25,10, $row['Cantidad'], 1, 0, 'c', 0);
    $pdf->Cell(25,10, $row['Tel_Cliente'], 1, 0, 'c', 0);
    $pdf->Cell(40,10, $row['Dir_Cliente'], 1, 1, 'c', 0);
}
$pdf->Output();
?>